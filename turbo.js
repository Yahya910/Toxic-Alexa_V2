...
try {
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 777888, "message": teks, "footerText": "*_©☞ᴛᴜʀʙᴏ ᴀɴᴅ ᴊɪғɪ⁴⁰⁴_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© ☞ᴛᴜʀʙᴏ ᴀɴᴅ ᴊɪғɪ⁴⁰⁴_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        ...
                        switch(waktoo){
               case 0: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴😌"; break;
                case 1: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴😌"; break;
                case 2: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴😌"; break;
                case 3: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴😌"; break;
                case 4: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴😌"; break;
                case 5: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴😌"; break;
                case 6: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ\n-  ī.ᴀᴍ/ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴😌"; break;
                ...
                case 19: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴😌"; break;
                case 20: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴😌"; break;
                case 21: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴😌"; break;
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_©☞ᴛᴜʀʙᴏ ᴀɴᴅ ᴊɪғɪ⁴⁰⁴_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/916380260672?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
...
console.log(color('[EVAL]'), color(moment(mek.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'yellow'), color(`toxic-alexa brooo`))
ras = budy.slice(1)
function _(rem) {
 ...
 {denz.sendMessage(from, tlsm(), text, {quoted: mek})}} 	
			...
			for (let anji of setik){
				if (budy === anji){
					...
					denz.sendMessage(from, result, sticker, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴✘ ➫➬➭ ${anji}`, orderTitle: `𒈒 ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴ 𒈒➫➬➭ ${anji}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./media/vn/${anju}.mp3`)
					denz.sendMessage(from, result, audio, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴✘ ➫➬➭ ${anju}`, orderTitle: `𒈒 ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴ 𒈒➫➬➭  ${anju}`, sellerJid: '0@s.whatsapp.net'}}}, mimetype: 'audio/mp4', duration: 359996400, ptt: true})
					}
			}
			for (let anjh of imagi){
				if (budy === anjh){
					result = fs.readFileSync(`./media/image/${anjh}.jpg`)
					denz.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `✘ ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴✘ ➫➬➭ ${anjh}`, orderTitle: `𒈒 ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴𒈒➫➬➭ ${anjh}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return reply(mess.only.Badmin)
              if (args.length < 1) return reply('Text?')
              reply('ᴛʜɪs ɢʀᴏᴜᴘ ʜᴀᴄᴋɪɴɢ ʙʏ  ᴛᴏxɪᴄ-ᴀʟᴇxᴀ')
                tessgc = await getBuffer(`https://i.ibb.co/m4Qx3JG/20210319-204838.jpg`)
                   denz.updateProfilePicture (from, tessgc)
                   await sleep(1000)
                denz.groupUpdateSubject(from, `HACKED BY TOXIC-ALEXA`)
                await sleep(1000)
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ᴇʀʀᴏʀ-ᴀʟᴇʀᴛ* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "ꪶ͢ᴛᴏxɪᴄ-ᴀʟᴇxᴀꫂ⁩⁴⁰⁴",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/916380260672?text=Hi Bro"}}})
	}
    }
    }
    }
